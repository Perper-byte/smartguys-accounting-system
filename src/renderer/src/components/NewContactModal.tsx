...
export function NewContactModal({
    ...
    const handleSaveContact = async (e: React.FormEvent) => {
        ...
        try {
             ...
             * Save the contact.
             *
             * The selected type is now correctly passed here.
             */
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/70 backdrop-blur-sm animate-in fade-in duration-200 print:hidden">
            ...
            <div className="bg-white border border-[#B0DCDA] rounded-xl shadow-2xl w-[700px] max-w-[95vw] overflow-hidden text-gray-800 font-sans">
